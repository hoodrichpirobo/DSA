...
public class Resident implements Comparable<Resident>{
    ...
    public boolean equals(Object other) {
        ...
        return otherResident.getDni().equals(this.getDni());
    }
    ...
    public int compareTo(Resident other) {
        // TO BE COMPLETED
        int res = this.getSurname1().compareTo(other.getSurname1());
        if(res == 0){
            res = this.getSurname2().compareTo(other.getSurname2());
            if(res == 0){
                res = this.getName().compareTo(other.getName());
                if(res == 0) res = this.getDni().compareTo(other.getDni());
            }
        }
        return res;
    }
